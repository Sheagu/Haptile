...
python learning/dp/pipeline.py \
  ...
  --model_save_path /scratch/grp/luo/shiyi/project/tele-gsy/data/wipe_board_trimmed/ckpts/dp_img_pos_eef_delta \
  --use_train_test_split True \
  --representation_type img-pos-eef \
  --camera_indices 01 \
  --joint_state_dim 7 \
  --action_dim 7 \
  --eef_dim 6 \
  ...
  --wandb_exp_name wipe_board_trimmed_dp_img_pos_eef_delta
