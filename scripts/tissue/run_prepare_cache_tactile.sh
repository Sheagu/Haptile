...
python learning/dp/pipeline.py \
  --data_path /scratch/grp/luo/shiyi/project/tele-gsy/data_split/tissue \
  --model_save_path /scratch/grp/luo/shiyi/project/tele-gsy/data/tissue/ckpts/cache_prepare_dummy \
  --use_train_test_split True \
  --representation_type img-tactile_img-pos \
  --memmap_loader_path /scratch/grp/luo/shiyi/project/tele-gsy/data_split/tissue_train/01-False-mem-img-tactile.dat \
  --camera_indices 01 \
  --joint_state_dim 7 \
  --action_dim 7 \
  --eef_dim 6 \
