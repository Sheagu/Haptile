...
#SBATCH --job-name=prepare_cache_tactile
...
echo "Preparing cache data with tactile information:"
python learning/dp/pipeline.py \
  --data_path /scratch/grp/luo/shiyi/project/tele-gsy/data_split/remove_cloth_trimmed \
  --model_save_path /scratch/grp/luo/shiyi/project/tele-gsy/data/remove_cloth_trimmed/ckpts/cache_prepare_dummy \
