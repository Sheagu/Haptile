...
python learning/dp/pipeline.py \
  ...
  --model_save_path /scratch/grp/luo/shiyi/project/tele-gsy/data/wipe_board_trimmed/ckpts/dp_img_pos_delta \
  ...
  --wandb_exp_name wipe_board_trimmed_dp_img_pos_delta
