...
python learning/dp/pipeline.py \
  --data_path /path/to/project/data_split/peg_in_hole \
  --model_save_path /path/to/project/data/peg_in_hole/ckpts/cache_prepare_dummy \
  --use_train_test_split True \
  --representation_type img-tactile_img-pos \
  --memmap_loader_path /path/to/project/data_split/peg_in_hole_train/01-False-mem-img-tactile.dat \
  --camera_indices 01 \
  --joint_state_dim 7 \
  --action_dim 7 \
  --eef_dim 6 \
